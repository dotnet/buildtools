...
set ROSLYNCOMPILERS_VERSION=3.1.0-beta3-19217-05
...
@echo on
call "%DOTNET_CMD%" build "%TOOLRUNTIME_DIR%\ilasm\ilasm.depproj" -r %NATIVE_TOOLS_RID% %TOOLRUNTIME_RESTORE_ARGS% /p:ILAsmPackageVersion=%ILASMCOMPILER_VERSION%
